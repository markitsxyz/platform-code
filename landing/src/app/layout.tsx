...
export const metadata: Metadata = {
  title: 'markits.xyz | Build, Trade & Scale On Solana',
  ...
  keywords: 'Solana, DeFi, token creation, SPL tokens, trading, markets, distribution, blockchain, cryptocurrency, markits',
  authors: [{ name: 'markits Team' }],
  openGraph: {
    title: 'markits.xyz | Complete Solana DeFi Platform',
