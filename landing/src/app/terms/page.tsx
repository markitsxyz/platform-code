...
export const metadata: Metadata = {
  title: 'Terms of Service | markits',
  description: 'Terms of Service for markits - Complete Solana DeFi Platform',
}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                By accessing and using markits, you accept and agree to be bound by the terms and 
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                markits provides a comprehensive Solana DeFi platform including:
              </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                As a user of markits, you agree to:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                markits is provided "as is" without warranties of any kind. We do not guarantee:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                <a href="mailto:legal@markits.xyz" className="text-primary hover:underline">
                  legal@markits.xyz
                </a>
              </p>
            </CardContent>
