...
// NFT details
const NFT_NAME = "markits Platform Pass";
...
export async function GET() {
  const response: GetResponse = {
    ...
    icon: "https://app.markits.xyz/logo/logo_single.png",
  };
...
async function createNFTTransaction(account: PublicKey): Promise<PostResponse> {
  ...
  const message = `Purchase your markits Platform Pass for ${PRICE_USDC} USDC + ${totalRequiredSOL} SOL (NFT rent + fees) - Partially signed, ready for your signature`;
