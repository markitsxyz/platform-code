...
import { Menu, X, Rocket, TrendingUp, ArrowRight } from "lucide-react"
    ...
    <motion.nav
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            <div className="relative w-10 h-10 bg-primary/20 border border-primary/30 rounded-lg flex items-center justify-center group hover:bg-primary/30 transition-colors duration-300">
              <TrendingUp className="h-6 w-6 text-primary group-hover:scale-110 transition-transform duration-300" />
              <ArrowRight className="absolute h-4 w-4 text-primary/60 -right-1 -top-1 group-hover:translate-x-1 transition-transform duration-300" />
            </div>
            <span className="text-2xl font-bold text-foreground">markits</span>
          </motion.div>
