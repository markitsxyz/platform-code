...
const faqs = [
  ...
  },
  {
    ...
    answer: "No coding knowledge is required! markits is designed to be completely user-friendly. Our intuitive interface guides you through every step of the token creation process."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes! markits uses audited smart contracts and follows best security practices. Your wallet remains in your control at all times, and we never have access to your private keys."
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            Everything you need to know about markits
          </p>
        </motion.div>
        ...
        >
          ...
          <Button 
            ...
            size="lg"
            className="group"
            onClick={() => window.open('https://t.me/markits', '_blank')}
          >
