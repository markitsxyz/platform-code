...
const testimonials = [
  {
    name: "Alex Chen",
    role: "DeFi Developer",
    content: "I was amazed at how simple and affordable it is to launch a token with markits. It's definitely the most budget-friendly option out there for token creators.",
    rating: 5,
    avatar: "AC",
  },
  {
    ...
    content: "Using markits was a game changer for my small project. The platform's simplicity allowed me to launch my token without hiring a dev team.",
    rating: 5,
    avatar: "SJ",
  },
  {
    ...
    content: "The simplicity of markits is amazing. You come, make your token, and that's it. It's perfect for launching lots of tokens fast and without hassle.",
    rating: 5,
    avatar: "MR",
  },
  {
    ...
    content: "I keep using markits because it's just so simple and cheaper than others. It's perfect for anyone who wants to launch tokens without knowing code.",
    rating: 5,
    avatar: "EW",
  },
  {
    name: "David Kim",
    role: "Web3 Founder",
    content: "What I love about markits is that it's super user-friendly. Even if you're new to this, you can easily create your token and get going in no time.",
    rating: 5,
    avatar: "DK",
  },
  {
    name: "Lisa Zhang",
    role: "Token Creator",
    content: "Just popped my token out on markits.xyz like it was nothing. Thought it'd be a brain buster but nah, smooth sailing.",
    rating: 5,
    avatar: "LZ",
  },
]
