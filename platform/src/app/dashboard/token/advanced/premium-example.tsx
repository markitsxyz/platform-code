...
export default function AdvancedTokenPage() {
  return (
    <PremiumGuard
      customMessage="🚀 Advanced token management features require a markits Platform Pass. Unlock priority processing, exclusive tools, and premium support."
    ...
    >
      <div>
        ...
        <a href="https://markits.xyz/nft-pass" target="_blank" rel="noopener noreferrer">
          Get markits Platform Pass
        </a>
      </div>
    </PremiumGuard>
  );
       ...
       <div>
         ...
         {hasNFTPass ? (
           ...
           <UpgradePrompt 
             ...
             href="https://markits.xyz/nft-pass"
           />
         )}
       </div>
     );
