      ...
      >
        <Stack spacing={3} alignItems="center">
          ...
          <Typography variant="h5" color="text.primary" fontWeight="bold">
            Verifying Your markits Platform Pass
          </Typography>
              ...
              >
                ...
                <CardContent sx={{ pt: 6, pb: 4, px: 4 }}>
                  <Typography variant="h4" gutterBottom fontWeight="bold" color="text.primary">
                    markits Platform Pass Required
                  </Typography>
                  
                  <Typography variant="body1" color="text.secondary" paragraph sx={{ mb: 3, lineHeight: 1.6 }}>
                    {customMessage || 
                      'Access to the markits dashboard requires a Platform Pass NFT. This exclusive pass grants you access to premium token creation tools, advanced features, and priority support.'
                    }
                  </Typography>
                  ...
                  <Stack spacing={2} sx={{ mb: 3 }}>
                    ...
                    >
                      Get Your markits Platform Pass
                    </Button>
                  ...
                  <Box sx={{ p: 2, bgcolor: 'grey.50', borderRadius: 2, textAlign: 'left' }}>
                    ...
                    <Typography variant="caption" color="text.secondary">
                      • Make sure your wallet is connected and contains the markits Platform Pass NFT<br/>
