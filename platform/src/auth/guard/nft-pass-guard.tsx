        ...
        >
          ...
          <CardContent sx={{ pt: 6, pb: 4, px: 4 }}>
            ...
            <Typography variant="body1" color="text.secondary" paragraph sx={{ mb: 3, lineHeight: 1.6 }}>
              {customMessage || 
                'This feature requires a markits Platform Pass NFT. Get exclusive access to premium tools, priority support, and advanced features on the Solana blockchain.'
              }
            </Typography>
